...
# 11 "MCAL_LAYER/Timer1/../std_libraries.h" 2
...
# 16 "MCAL_LAYER/Timer1/../interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_LAYER/Timer1/../interrupt/../GPIO/../device_config/device_config.h" 1
# 16 "MCAL_LAYER/Timer1/../interrupt/../GPIO/hal_gpio.h" 2
# 42 "MCAL_LAYER/Timer1/../interrupt/../GPIO/hal_gpio.h"
typedef enum{ LOW=0,
              HIGH
}logic_t;
...
# 16 "MCAL_LAYER/Timer1/../interrupt/mcal_interrupt_config.h" 2
...
Std_ReturnType TMR1_Init (const TMR1_t* obj){
    ...
    if (((void*)0) == obj){
        ...
        if (obj->mode == 0){
            ...
            (T1CONbits.TMR1CS=1);
              if (obj->Counter_mode==0 ){(T1CONbits.T1SYNC=0);}
              else if (obj->Counter_mode==1 ){(T1CONbits.T1SYNC=1);}
              else{ }
        }
        else{ }
