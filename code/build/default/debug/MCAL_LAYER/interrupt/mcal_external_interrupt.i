...
# 228 "MCAL_LAYER/interrupt/mcal_external_interrupt.c"
static Std_ReturnType Interrupt_INTx_Enable (const interrupt_INTx_t * int_obj){
...
static Std_ReturnType Interrupt_INTx_Disable (const interrupt_INTx_t * int_obj){
    ...
    if (((void*)0) == int_obj ){
        ...
        switch (int_obj->intx){
                case EXT_INT0 : (INTCONbits.INT0IE=0); ret=(Std_ReturnType) 0x01;break;
                case EXT_INT1 : (INTCON3bits.INT1IE=0); ret=(Std_ReturnType) 0x01;break;
                case EXT_INT2 : (INTCON3bits.INT2IE=0); ret=(Std_ReturnType) 0x01;break;
                default :ret=(Std_ReturnType) 0x00;
            }
...
# 337 "MCAL_LAYER/interrupt/mcal_external_interrupt.c"
static Std_ReturnType Interrupt_INTx_Edge_Init (const interrupt_INTx_t * int_obj){
    ...
    if (((void*)0) == int_obj ){
        ret=(Std_ReturnType) 0x00;
          ...
          switch (int_obj->intx){
                case EXT_INT0 :
                    if (Failing_Edge==int_obj->edge){(INTCON2bits.INTEDG0=0);}
                    else if (Rising_Edge==int_obj->edge){(INTCON2bits.INTEDG0=1);}
                    else { }
                    ret=(Std_ReturnType) 0x01;
                    break;
                case EXT_INT1 :
                    if (Failing_Edge==int_obj->edge){(INTCON2bits.INTEDG1=0);}
                    else if (Rising_Edge==int_obj->edge){(INTCON2bits.INTEDG1=1);}
                    else { }
                    ret=(Std_ReturnType) 0x01;
                    break;
                case EXT_INT2 :
                     if (Failing_Edge==int_obj->edge){(INTCON2bits.INTEDG2=0);}
                    else if (Rising_Edge==int_obj->edge){(INTCON2bits.INTEDG2=1);}
                    else { }
                    ret=(Std_ReturnType) 0x01;
                    break;
                default :
...
static Std_ReturnType Interrupt_INTx_ClearFlag (const interrupt_INTx_t * int_obj){
    ...
    if (((void*)0) == int_obj ){
        ...
        switch (int_obj->intx){
                case EXT_INT0 : (INTCONbits.INT0IF=0); ret=(Std_ReturnType) 0x01;break;
                case EXT_INT1 : (INTCON3bits.INT1IF=0); ret=(Std_ReturnType) 0x01;break;
                case EXT_INT2 : (INTCON3bits.INT2IF=0); ret=(Std_ReturnType) 0x01;break;
                default :ret=(Std_ReturnType) 0x00;
            }
...
static Std_ReturnType INT0_SetInterruptHandler (void (*INTx_InterruptHandeler) (void)){
         ...
         Std_ReturnType ret = (Std_ReturnType) 0x01;
    if (((void*)0) == INTx_InterruptHandeler ){
        ret=(Std_ReturnType) 0x00;
    }
    else{
...
static Std_ReturnType SetInterruptHandler (const interrupt_INTx_t * int_obj){
    ...
    if (((void*)0) == int_obj ){
        ...
        switch (int_obj->intx){
                case EXT_INT0 : INT0_SetInterruptHandler(int_obj->EXT_InterruptHandeler); ret=(Std_ReturnType) 0x01;break;
                case EXT_INT1 : INT1_SetInterruptHandler(int_obj->EXT_InterruptHandeler); ret=(Std_ReturnType) 0x01;break;
                case EXT_INT2 : INT2_SetInterruptHandler(int_obj->EXT_InterruptHandeler); ret=(Std_ReturnType) 0x01;break;
                default :ret=(Std_ReturnType) 0x00;
            }
