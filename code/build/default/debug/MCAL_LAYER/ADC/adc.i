...
# 14 "MCAL_LAYER/ADC/../mcal_std_types.h"
...
# 1 "MCAL_LAYER/ADC/../interrupt/../GPIO/hal_gpio.h" 1
# 16 "MCAL_LAYER/ADC/../interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_LAYER/ADC/../interrupt/../GPIO/../device_config/device_config.h" 1
# 16 "MCAL_LAYER/ADC/../interrupt/../GPIO/hal_gpio.h" 2
# 42 "MCAL_LAYER/ADC/../interrupt/../GPIO/hal_gpio.h"
typedef enum{ LOW=0,
              HIGH
}logic_t;
...
# 16 "MCAL_LAYER/ADC/../interrupt/mcal_interrupt_config.h" 2
...
typedef struct {
    ...
    AN_CHANNEL ANT;
    Conversion_Clock Clock;
    Acquisition_Time Acq_Time;
    uint_8 voltage_reference_flag ;
    uint_8 Result_flag ;
}ADC_PIN;
...
Std_ReturnType ADC_Init (const ADC_PIN * pin){
    ...
    if (((void*)0) == pin){
        ...
        ADCON2bits.ACQT=pin->Acq_Time;
         ...
         (PIE1bits.ADIE=1);
         (PIR1bits.ADIF=0);
# 63 "MCAL_LAYER/ADC/adc.c"
         ADC_InterruptHandler=pin->ADC_InterruptHandler;




         if (pin->Result_flag == 1){(ADCON2bits.ADFM=1);}
         else {(ADCON2bits.ADFM=0); }




         if (&(pin->voltage_reference_flag) == 1){do {ADCON1bits.VCFG0=1;ADCON1bits.VCFG1=1;}while(0);}
         else {do {ADCON1bits.VCFG0=0;ADCON1bits.VCFG1=0;}while(0); }
...
Std_ReturnType ADC_ConversionStatus (const ADC_PIN * pin, uint_8 * status){
     ...
     Std_ReturnType ret = (Std_ReturnType) 0x01;
    if (((void*)0) == pin && ((void*)0) == status ){
        ret=(Std_ReturnType) 0x00;
    }
    else{

        *status=!((ADCON0bits.GODONE));
...
Std_ReturnType ADC_GetResult (const ADC_PIN * pin, uint_16 * result){
     ...
     Std_ReturnType ret = (Std_ReturnType) 0x01;
    if (((void*)0) == pin && ((void*)0) == result ){
        ret=(Std_ReturnType) 0x00;
    }
    else{

        if (pin->Result_flag == 1){
...
static void ADC_Set_bit (AN_CHANNEL channel ){
    switch (channel){
        ...
        case ADC_AN0 : (TRISA |= ((uint_8)1<<0x0));break;
        case ADC_AN1 : (TRISA |= ((uint_8)1<<0x1));break;
        case ADC_AN2 : (TRISA |= ((uint_8)1<<0x2));break;
        case ADC_AN3 : (TRISA |= ((uint_8)1<<0x3));break;
        case ADC_AN4 : (TRISA |= ((uint_8)1<<0x5));break;
        case ADC_AN5 : (TRISE |= ((uint_8)1<<0x0));break;
        case ADC_AN6 : (TRISE |= ((uint_8)1<<0x1));break;
        case ADC_AN7 : (TRISE |= ((uint_8)1<<0x2));break;
        case ADC_AN8 : (TRISB |= ((uint_8)1<<0x2));break;
        case ADC_AN9 : (TRISB |= ((uint_8)1<<0x3));break;
        case ADC_AN10 : (TRISB |= ((uint_8)1<<0x1));break;
        case ADC_AN11 : (TRISB |= ((uint_8)1<<0x4));break;
        case ADC_AN12 : (TRISB |= ((uint_8)1<<0x0));break;
    }
}
