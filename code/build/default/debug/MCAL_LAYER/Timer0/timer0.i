...
# 11 "MCAL_LAYER/Timer0/../std_libraries.h" 2
...
# 1 "MCAL_LAYER/Timer0/../interrupt/../GPIO/hal_gpio.h" 1
# 16 "MCAL_LAYER/Timer0/../interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_LAYER/Timer0/../interrupt/../GPIO/../device_config/device_config.h" 1
# 16 "MCAL_LAYER/Timer0/../interrupt/../GPIO/hal_gpio.h" 2
# 42 "MCAL_LAYER/Timer0/../interrupt/../GPIO/hal_gpio.h"
typedef enum{ LOW=0,
              HIGH
}logic_t;
...
# 16 "MCAL_LAYER/Timer0/../interrupt/mcal_interrupt_config.h" 2
...
Std_ReturnType Timer0_Init (const Timer0_t* obj){
    ...
    if (((void*)0) == obj){
        ...
        if (obj->Register_Size_flag == 1 ){
            (T0CONbits.T08BIT=1);
        }
        else if (obj->Register_Size_flag == 0 ){
            (T0CONbits.T08BIT=0);
        }
        else{ }
        ...
        if (obj->mode == Timer_mode ){
            ...
            (T0CONbits.T0CS=1);
            if (obj->Edge_flag == 1){(T0CONbits.T0SE=0);}
            else if (obj->Edge_flag == 0){(T0CONbits.T0SE=1);}
            else{ }
        }
        else{ }
        ...
        else if (obj->PSA_flag == 0) {(T0CONbits.PSA=1);}
        else{ }
