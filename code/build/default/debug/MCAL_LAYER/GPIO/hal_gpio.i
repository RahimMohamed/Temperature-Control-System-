...
# 14 "MCAL_LAYER/GPIO/../mcal_std_types.h"
...
# 1 "MCAL_LAYER/GPIO/../device_config/device_config.h" 1
...
Std_ReturnType gpio_pin_Read_logic(const pin_config_t * _pin_config, logic_t* logic){
    ...
    if (((void*)0) == _pin_config || _pin_config->pin > (8 -1)){
        ...
        *logic=((*port_registers[_pin_config->port] >> _pin_config->pin)&(uint_8)1);
        *logic=((*port_registers[_pin_config->port] >> _pin_config->pin)&(uint_8)1);
        ...
        ret=(Std_ReturnType) 0x00;
         ...
         switch(logic){
            ...
            case LOW :
              ...
              (*lat_registers[_pin_config->port] &= ~((uint_8)1<<_pin_config->pin));
    ...
    if (((void*)0) == _pin_config || _pin_config->pin > (8 -1)){
        ...
        switch(_pin_config->direction){
            ...
            case GPIO_OUTPUT :
              ...
              (*tris_registers[_pin_config->port] &= ~((uint_8)1<<_pin_config->pin));
...
Std_ReturnType gpio_pin_direction_status(const pin_config_t * _pin_config, direction_t *dic_status){
 Std_ReturnType ret = (Std_ReturnType) 0x01;
    if (((void*)0) == _pin_config || _pin_config->pin > (8 -1)){
        ...
        *dic_status=((*tris_registers[_pin_config->port] >> _pin_config->pin)&(uint_8)1);
    }
