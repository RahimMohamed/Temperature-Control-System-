...
# 2 "<built-in>" 2
# 1 "MCAL_LAYER/CCP/CCP.c" 2
# 10 "MCAL_LAYER/CCP/CCP.c"
# 1 "MCAL_LAYER/CCP/CCP.h" 1
# 14 "MCAL_LAYER/CCP/CCP.h"
...
# 14 "MCAL_LAYER/CCP/CCP.h" 2

# 1 "MCAL_LAYER/CCP/../mcal_std_types.h" 1
# 14 "MCAL_LAYER/CCP/../mcal_std_types.h"
# 1 "MCAL_LAYER/CCP/../compiler.h" 1
# 14 "MCAL_LAYER/CCP/../mcal_std_types.h" 2
...
# 16 "MCAL_LAYER/CCP/../interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_LAYER/CCP/../interrupt/../GPIO/../device_config/device_config.h" 1
# 16 "MCAL_LAYER/CCP/../interrupt/../GPIO/hal_gpio.h" 2
# 42 "MCAL_LAYER/CCP/../interrupt/../GPIO/hal_gpio.h"
typedef enum{ LOW=0,
              HIGH
}logic_t;
...
# 16 "MCAL_LAYER/CCP/../interrupt/mcal_interrupt_config.h" 2
# 56 "MCAL_LAYER/CCP/../interrupt/mcal_interrupt_config.h"
typedef enum {
...
typedef enum {
    Timer1_Config_For_Module=0,
    Timer1CCP1_Timer3CCP2,
    Timer3_Config_For_Module,
}CCPx_Timer_mode;
...
Std_ReturnType CCPx_Init (const CCPx_t* ccp_obj){
    ...
    if (((void*)0) ==ccp_obj){
        ...
        if (ccp_obj->CCPx == 1){(CCP1CONbits.CCP1M=((uint_8)0x00));}
        else if (ccp_obj->CCPx == 2){(CCP2CONbits.CCP2M=((uint_8)0x00));}
        else { }
...
Std_ReturnType CCP_PWM_Start(const CCPx_t *ccp_obj){
    ...
    if (((void*)0) ==ccp_obj){
        ret=(Std_ReturnType) 0x00;
         ...
         if (ccp_obj->CCPx == 1){(CCP1CONbits.CCP1M=((uint_8) 0x0C));}
        else if (ccp_obj->CCPx == 2){(CCP2CONbits.CCP2M=((uint_8) 0x0C));}
        else { }
...
static void CCPx_SET_CAPTURE_MODE (const CCPx_t * ccp_obj){
   ...
   if (ccp_obj->CCPx == 1){
       switch (ccp_obj->sub_mode){
           case ((uint_8) 0x04): (CCP1CONbits.CCP1M=((uint_8) 0x04));
           break;
           case ((uint_8) 0x05): (CCP1CONbits.CCP1M=((uint_8) 0x05));
           break;
           case ((uint_8) 0x06): (CCP1CONbits.CCP1M=((uint_8) 0x06));
           break;
           case ((uint_8) 0x07): (CCP1CONbits.CCP1M=((uint_8) 0x07));
           break;
       }
   }
   else if (ccp_obj->CCPx == 2){
        switch (ccp_obj->sub_mode){
           case ((uint_8) 0x04): (CCP2CONbits.CCP2M=((uint_8) 0x04));
           break;
           case ((uint_8) 0x05): (CCP2CONbits.CCP2M=((uint_8) 0x05));
           break;
           case ((uint_8) 0x06): (CCP2CONbits.CCP2M=((uint_8) 0x06));
           break;
           case ((uint_8) 0x07): (CCP2CONbits.CCP2M=((uint_8) 0x07));
           break;
       }
...
static void CCPx_SET_COMPARE_MODE (const CCPx_t * ccp_obj){
     if (ccp_obj->CCPx == 1){
       switch (ccp_obj->sub_mode){
           case ((uint_8) 0x08): (CCP1CONbits.CCP1M=((uint_8) 0x08));
           break;
           case ((uint_8) 0x09): (CCP1CONbits.CCP1M=((uint_8) 0x09));
           break;
           case ((uint_8) 0x02): (CCP1CONbits.CCP1M=((uint_8) 0x02));
           break;
           case ((uint_8) 0x0A): (CCP1CONbits.CCP1M=((uint_8) 0x0A));
           break;
           case ((uint_8) 0x0B): (CCP1CONbits.CCP1M=((uint_8) 0x0B));
           break;
       }
   }
   else if (ccp_obj->CCPx == 2){
        switch (ccp_obj->sub_mode){
           case ((uint_8) 0x08) : (CCP2CONbits.CCP2M=((uint_8) 0x08));
           break;
           case ((uint_8) 0x09) : (CCP2CONbits.CCP2M=((uint_8) 0x09));
           break;
           case ((uint_8) 0x02): (CCP2CONbits.CCP2M=((uint_8) 0x02));
           break;
           case ((uint_8) 0x0A) : (CCP2CONbits.CCP2M=((uint_8) 0x0A));
           break;
           case ((uint_8) 0x0B) : (CCP2CONbits.CCP2M=((uint_8) 0x0B));
           break;
       }
...
static void CCPx_SET_PWM_MODE (const CCPx_t * ccp_obj){
     ...
     if (ccp_obj->CCPx == 1){
       (CCP1CONbits.CCP1M=((uint_8) 0x0C));
   }
   else if (ccp_obj->CCPx == 2){
      (CCP2CONbits.CCP2M=((uint_8) 0x0C));
   }
   else { }

  PR2=(uint_8)( (8000000UL / (ccp_obj->PWM_Frequency * 4.0 * ccp_obj->timer2_Pos * ccp_obj->timer2_Prescaler))-1 );
