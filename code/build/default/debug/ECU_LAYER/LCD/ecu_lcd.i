...
# 14 "ECU_LAYER/LCD/../../MCAL_LAYER/GPIO/hal_gpio.h"
...
# 1 "ECU_LAYER/LCD/../../MCAL_LAYER/GPIO/../device_config/device_config.h" 1
# 16 "ECU_LAYER/LCD/../../MCAL_LAYER/GPIO/hal_gpio.h" 2
# 42 "ECU_LAYER/LCD/../../MCAL_LAYER/GPIO/hal_gpio.h"
typedef enum{ LOW=0,
              HIGH
}logic_t;
...
Std_ReturnType lcd_4bit_send_custom_char (const lcd_4bit_t *lcd,uint_8 row,uint_8 column, uint_8 chr[],uint_8 mem_pos){
    ...
    if (((void*)0) == lcd ){
        ...
        lcd_4bit_send_command(lcd,(0X40 + (mem_pos*8)));
...
Std_ReturnType lcd_8bit_send_custom_char (const lcd_8bit_t *lcd,uint_8 row,uint_8 column, uint_8 chr[],uint_8 mem_pos){
    ...
    if (((void*)0) == lcd ){
        ...
        lcd_8bit_send_command(lcd,(0X40 + (mem_pos*8)));
        for(cust_counter=0;cust_counter<=7;cust_counter++){
